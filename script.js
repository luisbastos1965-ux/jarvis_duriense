...
// ----------------------------------------------------
// AQUECIMENTO INVISÍVEL DO MOTOR DE VOZ
// ----------------------------------------------------
...
orb.addEventListener('click', (e) => {
    e.stopPropagation(); 
    if(isLongPress) return; // Aborta o click se tiver sido um Long Press
...
// ==============================================================================
const mobileWines = [
    { id: 'w7', type: "Vinho do Porto", name: "Quinta do Paraíso Vintage", price: "85.00€", img: "Vinho7.png", link: "https://burmester.pt/vinhos/vintage-2018-quinta-do-arnozelo/", desc: "Cor vermelho opaco. Notas de flor de laranjeira, cassis e frutos do bosque." },
    { id: 'w1', type: "Rosé", name: "Tavedo Rosé", price: "18.00€", img: "Vinho1.png", link: "https://burmester.pt/vinhos/tavedo-rose/", desc: "Frescura imediata. Frutos vermelhos imiscuem-se com nuances mentoladas." },
    { id: 'w2', type: "Branco", name: "Branco Clássico", price: "22.50€", img: "Vinho2.png", link: "https://burmester.pt/vinhos/burmester-branco/", desc: "Elegância pautada pela frescura das notas cítricas envoltas em ervas frescas." },
    { id: 'w3', type: "Branco Reserva", name: "Casa Branco", price: "35.00€", img: "Vinho3.png", link: "https://burmester.pt/vinhos/casa-burmester-branco/", desc: "Cativa pela fruta amarela e ervas frescas. Vibrante, cheio no corpo." },
    { id: 'w4', type: "Tinto Reserva", name: "Touriga Nacional", price: "45.00€", img: "Vinho4.png", link: "https://burmester.pt/vinhos/casa-burmester-touriga-nacional-2018/", desc: "Apresenta delicadas notas florais envolvidas pela exuberância de fruta preta." },
    { id: 'w5', type: "Tinto", name: "Casa Tinto", price: "28.00€", img: "Vinho5.png", link: "https://burmester.pt/vinhos/casa-burmester-tinto/", desc: "A fruta preta sobressai num fundo de especiarias. Textura aveludada." },
    { id: 'w6', type: "Vinho do Porto", name: "Tawny Clássico", price: "32.00€", img: "Vinho6.png", link: "https://burmester.pt/vinhos/burmester-tawny-port/", desc: "Cor castanha-aloirada. Fruta madura com sedutoras nuances abaunilhadas." }
];
...
window.openGarrafeira = function() {
    ...
    mobileWines.forEach(w => {
        container.innerHTML += `
            <div class="m-wine-card" id="card-${w.id}">
                <div class="m-wine-inner">
                    <div class="m-wine-front" ${w.id === 'w7' ? 'style="border-color:var(--accent-color);"' : ''}>
                        ...
                        <button class="m-btn-buy" style="background:transparent; border:1px solid var(--accent-color); color:var(--accent-color);" onclick="document.getElementById('card-${w.id}').classList.add('flipped')">Informações</button>
                    </div>
                    <div class="m-wine-back" ${w.id === 'w7' ? 'style="border-color:var(--accent-color);"' : ''}>
                        ...
                        <div style="display:flex; flex-direction:column; gap:10px; width:100%; margin-top:20px;">
                            <button class="m-btn-buy" onclick="window.open('${w.link}', '_blank')">Comprar</button>
                            <button class="m-btn-buy" style="background:transparent; border:1px solid #888; color:#fff;" onclick="document.getElementById('card-${w.id}').classList.remove('flipped')">Voltar</button>
                        </div>
                    </div>
                </div>
            </div>
